...
adjectivelist = ["A grim", "A spotless", "An overcrowded", "A worn down", "An ancient", "A brand new", "A creepy", "A rought", "A fancy",\
	"An ugly", "A noisy", "A elegant", "A fashonoble", "A high end", "A sprawling"]
